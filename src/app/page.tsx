...
const Home: FC = () => (
  <div className="w-full">
    ...
    <section className="mx-auto flex w-full max-w-5xl flex-col items-center px-5 pt-16 pb-16 text-center md:pt-24">
      <LogoMark
        className="text-foreground mb-10 h-28 w-auto md:h-36"
        aria-hidden
      />
    ...
    <section
      id="features"
      className="mx-auto w-full max-w-6xl px-5 pt-8 pb-16"
    >
    ...
    <section
      id="concepts"
      className="mx-auto w-full max-w-4xl px-5 pt-8 pb-16"
    >
      <div className="mb-10">
        <p className="text-muted-foreground text-xs tracking-wider uppercase">
          What digga looks up
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <div className="border-border/60 bg-card/50 flex flex-col gap-5 rounded-2xl border p-6">
          <div>
            ...
            <p className="text-muted-foreground mt-2 text-sm leading-relaxed">
              Drag the button below into your bookmark bar. Click it on any
              site to jump straight to the digga results for that domain.
            </p>
          </div>
          <BookmarkletLink />
        </div>
        ...
        <div className="border-border/60 bg-card/50 flex flex-col gap-5 rounded-2xl border p-6">
          <div>
            ...
            <p className="text-muted-foreground mt-2 text-sm leading-relaxed">
              Add the shortcut to your iPhone or iPad share sheet. Trigger it
              on any web page to research the current domain instantly.
            </p>
          </div>
          <IOSShortcutLink />
        </div>

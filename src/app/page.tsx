...
import ExtensionPromo from '@/components/install/extension-promo';
	...
	<div className="w-full">
		...
		<section id="install" className="mx-auto w-full max-w-4xl px-5 pt-8 pb-16">
			...
			<div className="mb-4 grid grid-cols-1 gap-4 md:grid-cols-2">
				{EXTENSION_TARGET_LIST.map(({ browser, name, Icon }) => (
					<div
						key={browser}
						className="border-border/60 bg-card/50 flex flex-col gap-5 rounded-2xl border p-6"
					>
						<div className="flex flex-1 items-start gap-4">
							...
							<div>
								...
								<p className="text-muted-foreground mt-2 text-sm leading-relaxed">
									Right click any page and jump straight to the digga report for that domain. No
									copy paste, no typing.
								</p>
							</div>
						</div>
						<ExtensionLink browser={browser} />
					</div>
				))}
			</div>

...
const NotFound: FC = () => (
	<div className="mx-auto max-w-2xl px-4 pt-24 pb-16 text-center">
		...
		<h1 className="text-foreground text-2xl font-semibold tracking-tight">Not a valid domain</h1>
		<p className="text-muted-foreground mt-3 text-base">
			The thing you typed does not look like a domain we can look up. Try an apex, subdomain, or
			full URL.
		</p>

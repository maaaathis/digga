      ...
      <AlertDialog open={open} onOpenChange={setOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This link is a bookmarklet. Drag it into your browser bookmark bar
              instead of clicking. Once saved, you can hit it from any site to
              jump straight to the digga results page for that domain.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>

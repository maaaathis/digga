	...
	return (
		<DialogPrimitive.Overlay
			...
			className={cn(
				...
				'ease-out-expo fill-mode-both data-open:animate-in data-open:fade-in-0 data-open:duration-300 data-closed:animate-out data-closed:fade-out-0 data-closed:duration-150 data-closed:ease-in',
				className,
			)}
			{...props}
		/>
		...
		<DialogPortal>
			...
			<DialogPrimitive.Content
				...
				className={cn(
					...
					'ease-out-expo fill-mode-both',
					'data-open:animate-in data-open:fade-in-0 data-open:zoom-in-97 data-open:slide-in-from-bottom-2 data-open:duration-300',

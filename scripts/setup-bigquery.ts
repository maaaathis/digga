...
async function ensureDataset(
	...
	const accessToken = await token('https://www.googleapis.com/auth/bigquery', credentials);
...
async function main(): Promise<void> {
	...
	console.log(`Project: ${credentials.project_id}, dataset: ${dataset}, location: ${location}`);
